...
export const POST_BODY_REQUIRED = "Text is required!";
export const CATEGORY_REQUIRED = "Category is required!";
export const POSTS_NOT_FOUND = "Posts not found!";
export const POST_NOT_FOUND = "Post not found!";
export const NOT_AUTHORIZED = "You are not authorized!";
export const COMMENT_BODY_REQUIRED = "Comment text is required!";
export const COMMENT_NOT_FOUND = "Comment not found!";
export const PROBLEM_NOT_FOUND = "Problem not found!";
