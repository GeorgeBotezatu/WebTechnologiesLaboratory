...
export const CAN_NOT_ENROLL = "Can't enroll to this course!";
export const YOU_ARE_NOT_ENROLED = "You are not enrolled to this course!";
...
export const CAN_NOT_LOAD_POSTS_LIST = "Can't load posts list!";
export const CAN_NOT_LOAD_POST = "Can't load post!";
export const CAN_NOT_DELETE_POST = "Can't delete post!";
export const CAN_NOT_ADD_POST = "Can't add post!";
